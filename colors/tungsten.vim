...
if has("gui_running")
    ...
    call TungstenG("DiffAdd", s:color10G, s:color13G, "NONE")
    call TungstenG("DiffChange", s:color2G, s:color8G, "NONE")
    call TungstenG("DiffDelete", s:color9G, s:color13G, "NONE")
    call TungstenG("DiffText", s:color9G, s:color13G, "NONE")
    ...
    call TungstenG("Function", s:color1G, "", "NONE")
    ...
    call TungstenG("Type", s:color2G, "", "NONE")
    ...
    " mail
    call TungstenG("mailQuoted1", s:color1G, "", "NONE")
    call TungstenG("mailQuoted2", s:color5G, "", "NONE")
    call TungstenG("mailQuoted3", s:color2G, "", "NONE")
    call TungstenG("mailQuoted4", s:color6G, "", "NONE")
    call TungstenG("mailQuoted5", s:color4G, "", "NONE")
    " }}}
endif
...
if &t_Co==256
    ...
    call TungstenC("DiffAdd", s:color10C, s:color13C, "NONE")
    call TungstenC("DiffChange", s:color2C, s:color8C, "NONE")
    call TungstenC("DiffDelete", s:color9C, s:color13C, "NONE")
    call TungstenC("DiffText", s:color9C, s:color13C, "NONE")
    ...
    call TungstenC("Function", s:color1C, "", "NONE")
    ...
    call TungstenC("Type", s:color2C, "", "NONE")
    ...
    call TungstenC("mailQuoted2", s:color5C, "", "NONE")
    call TungstenC("mailQuoted3", s:color2C, "", "NONE")
    call TungstenC("mailQuoted4", s:color6C, "", "NONE")
    call TungstenC("mailQuoted5", s:color4C, "", "NONE")
    " }}}
endif
