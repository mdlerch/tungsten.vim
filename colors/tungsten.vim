...
if has("gui_running")
    ...
    call TungstenG("FoldColumn", s:color8G, s:color0G, "NONE")
    ...
    call TungstenG("SpellRare", s:color13G, "", "NONE")
...
if &t_Co==256
    ...
    call TungstenC("FoldColumn", s:color8C, s:color0C, "NONE")
    ...
    call TungstenC("SpellRare", s:color13C, "", "NONE")
