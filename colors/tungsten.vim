...
let s:color13C  = 138 " magenta 1 (purple)
let s:color14C  = 73  " cyan 1 (dim)
...
let s:color5C = 236 " magenta 2 (medium black)
let s:color6C = 252 " cyan 2 (medium white)
...
let s:color13G  = "#af8787" " magenta 1 (purple)
let s:color14G  = "#87ffff" " cyan 1 (dim)
...
let s:color5G = "#303030" " magenta 2 (medium black)
let s:color6G = "#d0d0d0" " cyan 2 (medium white)
...
if has("gui_running")
    ...
    call TungstenG("mailQuoted4", s:color14G, "", "NONE")
...
if &t_Co==256
    ...
    call TungstenC("mailQuoted4", s:color14C, "", "NONE")
